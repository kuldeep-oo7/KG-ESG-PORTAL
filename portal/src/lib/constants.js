...
export const GOODS_TYPES = [
  ...
  "benzaldehyde",
  "Benzene, C6H6(Chemical production, organic, aromatics)",
  ...
  "Boric acid, anhydrous, powder, H3BO3",
  ...
  "Fluosilisic acid, 22% in H2O, H2SiF6",
  ...
  "hexafluoroethane",
  "hexane",
  "Hydrochloric acid, 30% in H2O, HCl",
  ...
  "imidazole",
  "injection moulding",
  "Iron (II) chloride, 40% in H2O, FeCl3",
  "iron(II) chloride",
  ...
  "manganese sulfate",
  "manganese(III) oxide",
  "Market for Aluminium sulphate without water, in 4.33% aluminium solution state, powder, Al2(SO4)3",
  "melamine",
  ...
  "Phosphoric acid, industrial grade, 85% in H20, H3PO4",
  ...
  "polyvinyl chloride, unspecified polymerisation, weighted average",
  "polyvinylfluoride, dispersion",
  "polyvinylidenchloride, granulate",
  "Potassium carbonate prodution from Potassium hydroxide",
  "potassium hydroxide",
  ...
  "protein concentrate, 8% in water, from whey",
  "protein feed, 100% crude",
  "pyrethroid-compound",
  "pyridine",
  "pyridine-compound",
  "rosin size, for paper production",
  "sealing tape, aluminium/PE, 50 mm wide",
  "selenium",
  ...
  "sodium bicarbonate",
  "Sodium chloride, powder, NaCl",
  "sodium ethoxide",
  "sodium fluoride",
  "sodium formate",
  "sodium hydrosulfide",
  "Sodium hydroxide, 50% in H2O, production mix, NaOH",
  ...
  "turpentine to generic market for solvent for paint",
  "uranium, enriched 3.0%, per separative work unit",
  "uranium, enriched 3.8%, in fuel element for light water reactor",
  "uranium, enriched 3.8%, per separative work unit",
  "uranium, enriched 3.9%, in fuel element for light water reactor",
  "uranium, enriched 3.9%, per separative work unit",
  "uranium, enriched 4%, in fuel element for light water reactor",
  "uranium, enriched 4.0%, per separative work unit",
