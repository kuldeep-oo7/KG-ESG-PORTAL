...
export default function Scope2Summary() {
  ...
  const scope2Total = getScopeTotal(siteId, 2)
  ...
  return (
    <div className="flex-1 overflow-y-auto p-6 max-w-4xl">
      ...
      <h2 className="text-lg font-semibold text-slate-800 mb-1">Scope 2 Summary</h2>
      <p className="text-sm text-slate-500 mb-6">Total indirect greenhouse gas emissions from energy use</p>
      ...
      <div className="bg-[#064E3B] rounded-xl p-5 flex items-center justify-between text-white mb-8">
        <div>
          <p className="text-sm opacity-70">Total Scope 2 Emissions</p>
          <p className="text-3xl font-bold mt-1">{scope2Total.toFixed(6)}</p>
      ...
      <div className="flex justify-end gap-3">
        <button onClick={() => navigate(`/sites/${siteId}/scope2/renewable`)}
        ...
        <button onClick={() => navigate(`/sites/${siteId}/scope3/employee-commute`)}
